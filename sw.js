...
const CACHE_NAME='multiverse-wheel-v26-world-content-1';
const APP_SHELL=[
  './',
  ...
  './styles/app.css','./styles/v9.css','./styles/v13.css','./styles/v14.css','./styles/v15.css','./styles/v16.css','./styles/v17.css','./styles/v18.css','./styles/v19.css','./styles/v20.css','./styles/v21.css','./styles/v22.css','./styles/v23.css','./styles/v24.css','./styles/v25.css','./styles/v26.css',
  './character_image_manifest.js','./game_asset_manifest.js','./assets/game-asset-catalog.json',
  './js/config.js','./js/data/base.js','./js/data/expansion.js','./js/data/mega-roster.js','./js/data/world-content.js',
  './js/core.js','./js/v5-systems.js','./js/v6-custom-hero.js','./js/v8-everything.js','./js/v8-integration.js',
  './js/media-resolver.js','./js/performance.js','./js/world-asset-art.js',
...
self.addEventListener('activate',event=>{
  event.waitUntil(caches.keys().then(async keys=>{
    ...
    // Do not seize an already-open first-run page. Claim only when an older
    // Multiverse Wheel cache proves this activation is a real release upgrade.
