...
const CACHE_NAME='multiverse-wheel-v15-ascension-1';
const APP_SHELL=[
  './',
  ...
  './styles/app.css','./styles/v9.css','./styles/v13.css','./styles/v14.css','./styles/v15.css',
  ...
  './js/domain/derived-state-cache.js','./js/domain/collection-window.js','./js/domain/experience-engine.js','./js/domain/session-engine.js','./js/domain/v13-engine.js','./js/domain/v14-engine.js','./js/domain/v15-engine.js',
  ...
  './js/v13-foundation.js','./js/v13-shell.js','./js/v13-agency.js','./js/v13-combat.js','./js/v13-narrative.js','./js/v13-replay.js','./js/v14-experience.js','./js/v15-experience.js','./js/bootstrap.js',
