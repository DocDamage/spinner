...
const CACHE_NAME='multiverse-wheel-v13-shell-2';
const APP_SHELL=[
  './',
  ...
  './styles/app.css','./styles/v9.css','./styles/v13.css',
  './character_image_manifest.js',
  ...
  './js/domain/derived-state-cache.js','./js/domain/collection-window.js','./js/domain/experience-engine.js','./js/domain/session-engine.js','./js/domain/v13-engine.js',
  ...
  './js/v13-foundation.js','./js/v13-shell.js','./js/v13-agency.js','./js/v13-combat.js','./js/v13-narrative.js','./js/v13-replay.js','./js/bootstrap.js'
];
