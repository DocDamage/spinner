...
const CACHE_NAME='multiverse-wheel-v14-chronicle-1';
const APP_SHELL=[
  './',
  ...
  './js/domain/derived-state-cache.js','./js/domain/collection-window.js','./js/domain/experience-engine.js','./js/domain/session-engine.js','./js/domain/v13-engine.js','./js/domain/v14-engine.js',
  ...
  './js/v13-foundation.js','./js/v13-shell.js','./js/v13-agency.js','./js/v13-combat.js','./js/v13-narrative.js','./js/v13-replay.js','./js/v14-experience.js','./js/bootstrap.js',
